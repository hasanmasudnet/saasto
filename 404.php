   ...
   <div class="container">
      <div class="row">
         <div class="col-xxl-8 offset-xxl-2 col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
            <?php 
               $saasto_404_bg = get_theme_mod('saasto_404_bg',get_template_directory_uri() . '/assets/img/error/error.png');
            ...
            <div class="error__item text-center">
               ...
               <div class="error__content">
                  ...
                  <a href="<?php print esc_url(home_url('/'));?>" class="tp-btn"><?php print esc_html($saasto_error_link_text);?></a>
               </div>
            </div>
         </div>
      </div>
