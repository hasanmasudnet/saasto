...
/**
 * saasto functions and definitions
 *
 ...
 */
require SAASTO_THEME_INC . 'custom-header.php';

/**
 * Functions which enhance the theme by hooking into WordPress.
 */
require SAASTO_THEME_INC . 'template-functions.php';

/**
 * Custom template helper function for this theme.
 */
require SAASTO_THEME_INC . 'template-helper.php';

/**
 * initialize kirki customizer class.
 */
include_once SAASTO_THEME_INC . 'kirki-customizer.php';
include_once SAASTO_THEME_INC . 'class-saasto-kirki.php';
