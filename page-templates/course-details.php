                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="course__wrapper">
                        ...
                        <div class="course__img w-img mb-30">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/details/course-details-1.jpg" alt="img">
                        </div>
                                    ...
                                    <div class="course__comment mb-75">
                                       ...
                                       <ul>
                                          <li>
                                             <div class="course__comment-box ">
                                                <div class="course__comment-thumb float-start">
                                                   <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/comment/course-comment-1.jpg" alt="img">
                                                </div>
                                          ...
                                          <li>
                                             <div class="course__comment-box ">
                                                <div class="course__comment-thumb float-start">
                                                   <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/comment/course-comment-2.jpg" alt="img">
                                                </div>
                                                <div class="course__comment-content">
                                                   <div class="course__comment-wrapper ml-70 fix">
                                                      <div class="course__comment-info float-start">
                                 ...
                                 <div class="course__member mb-45">
                                       ...
                                       <div class="row align-items-center">
                                          <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-6">
                                             <div class="course__member-thumb d-flex align-items-center">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/instructor/course-instructor-1.jpg" alt="img">
                                    ...
                                    <div class="course__member-item">
                                       <div class="row align-items-center">
                                          <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-6">
                                             <div class="course__member-thumb d-flex align-items-center">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/instructor/course-instructor-2.jpg" alt="img">
                                                <div class="course__member-name ml-20">
                                                   <h5>Lauren Stamps</h5>
                                                   <span>Teacher</span>
                                                </div>
                                    ...
                                    <div class="course__member-item">
                                       <div class="row align-items-center">
                                          <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-6 ">
                                             <div class="course__member-thumb d-flex align-items-center">
                                                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/instructor/course-instructor-3.jpg" alt="img">
                                                <div class="course__member-name ml-20">
                                                   <h5>Jonquil Von</h5>
                                                   <span>Associate</span>
                                                </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4">
                     <div class="course__sidebar pl-70 p-relative">
                        <div class="course__shape">
                           <img class="course-dot" src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-dot.png" alt="img">
                        </div>
                        <div class="course__sidebar-widget-2 white-bg mb-20">
                           <div class="course__video">
                              <div class="course__video-thumb w-img mb-25">
                                 <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/video/course-video.jpg" alt="img">
                              ...
                              <div class="course__payment mb-35">
                                 <h3>Payment:</h3>
                                 <a href="#">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/payment/payment-1.png" alt="img">
                                 </a>
                              </div>
                              ...
                              <ul>
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-30">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="https://wprealizer.com/wp/saasto/course-details/">
                                             <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/sm/course-sm-1.jpg" alt="img">
                                          </a>
                                       </div>
                                       <div class="course__sm-content">
                                          ...
                                          <h5><a href="https://wprealizer.com/wp/saasto/course-details/">Development</a></h5>
                                 ...
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-30">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="https://wprealizer.com/wp/saasto/course-details/">
                                             <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/sm/course-sm-2.jpg" alt="img">
                                          </a>
                                       </div>
                                       <div class="course__sm-content">
                                          <div class="course__sm-rating">
                                          ...
                                          <h5><a href="https://wprealizer.com/wp/saasto/course-details/">Data Science</a></h5>
                                          <div class="course__sm-price">
                                             <span>$72.00</span>
                                          </div>
                                       </div>
                                 ...
                                 <li>
                                    <div class="course__sm d-flex align-items-center mb-10">
                                       <div class="course__sm-thumb mr-20">
                                          <a href="https://wprealizer.com/wp/saasto/course-details/">
                                             <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/sm/course-sm-3.jpg" alt="img">
                                          </a>
                                       </div>
                                       <div class="course__sm-content">
                                          <div class="course__sm-rating">
                                          ...
                                          <h5><a href="https://wprealizer.com/wp/saasto/course-details/">UX Design</a></h5>
                                          <div class="course__sm-price">
                                             <span>Free</span>
                                          </div>
                                       </div>
                     ...
                     <div class="course__popup-wrapper p-relative">
                        ...
                        <div class="course__popup-top d-flex align-items-start mb-40">
                           <div class="course__popup-thumb mr-20">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/course/course-sm-1.jpg" alt="img">
                           </div>
