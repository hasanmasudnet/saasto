        ...
        <div class="row gy-5 justify-content-between">
            <div class="col-lg-6 col-xl-6">
                <div class="section-header text-center text-md-start ">
                    ...
                    <div class="btn-group d-flex flex-column flex-sm-row align-items-start align-items-sm-center">
                        <a href="#" class="fill">
                            Get Started
                            <i class="bi bi-arrow-right-short"></i>
                        </a>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="notification-thumbnail">
                    ...
                    <img class='wow fadeInUp' data-wow-delay=".5s" data-wow-duration=".9s" src=<?php echo get_template_directory_uri() . '../assets/img/notification/popup.png' ?> alt="popub-img">
                </div>
            </div>
            <div class="col-md-6">
