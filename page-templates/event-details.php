                     ...
                     <div class="event__wrapper">
                        <div class="page__title-content mb-25">                          
                           <div class="breadcrumb__list breadcrumb__list-2 mb-10">
                              <span><a href="https://wprealizer.com/wp/saasto/">Home</a></span>
                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="event_wrapper">
                        <div class="event__thumb mb-35 w-img">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/img/events/event-1.jpg" alt="img">
                        </div>
                        ...
                        <div class="event__sidebar-widget white-bg mb-20">
                           ...
                           <div class="event__info">
                              ...
                              <div class="event__join-btn">
                                 <a href="https://wprealizer.com/wp/saasto/contact/" class="tp-btn text-center w-100">Enroll <i class="far fa-arrow-right"></i></a>
                              </div>
                           </div>
                        </div>
                        <div class="event__sidebar-widget white-bg">
                           <div class="event__sponsor">
                              ...
                              <div class="event__sponsor-thumb mb-35">
                                 <img src="<?php echo get_template_directory_uri(); ?>/assets/img/events/sponsor-logo.png" alt="img">
                              </div>
