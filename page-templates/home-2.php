                ...
                <div class="row justify-content-center min-vh-100 align-items-center section-gap-xl-bottom section-gap-xl-top">
                    <div class="col-lg-8 ">
                        <div class="hero-contents text-center position-relative mt-100">
                            ...
                            <div class="hero-btn">
                                <a href="<?php print esc_url( home_url('/pricing') ) ?>" class="btn-fill-pill wow fadeInUp">Start 14 Days Trial <span></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="partner-one-content">
                        <div class="text-start">
                            ...
                            <div class="partner-btn mt-5">
                                <a href="<?php print esc_url( home_url('/contact') ) ?>" class="btn-fill-outlined wow fadeInUp">Get Started</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="app-download-content-wrap">
                        ...
                        <div class="download-options">
                            <a href="<?php print esc_url( home_url('/contact') ) ?>" class="download-btn-fill">
                            ...
                            <a href="<?php print esc_url( home_url('/contact') ) ?>" class="download-btn-outlined">
