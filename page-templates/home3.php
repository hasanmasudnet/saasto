            ...
            <div class="slider__active swiper-container">
               <div class="swiper-wrapper">
                  <div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="<?php echo get_template_directory_uri(); ?>/assets/img/slider/3/slider-1.jpg"></div>
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                              <div class="slider__content-3 p-relative z-index-1">
                                 ...
                                 <h2 class="slider__title-3" data-animation="fadeInUp" data-delay=".6s">Launch Your <br> Own online learning Platform</h2>
                                 ...
                                 <div class="slider__list" data-animation="fadeInUp" data-delay="1.2s">
                                    <ul>
                                       <li><i class="fa-solid fa-check"></i> Access more then 120k online courses.</li>
                  ...
                  <div class="slider__item swiper-slide p-relative slider__height slider__height-3 d-flex align-items-center z-index-1">
                     <div class="slider__bg slider__overlay slider__overlay-3 include-bg" data-background="<?php echo get_template_directory_uri(); ?>/assets/img/slider/3/slider-2.jpg"></div>
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                              <div class="slider__content-3 p-relative z-index-1">
                  ...
                  <div class="col-xxl-7 col-xl-7">
                     <div class="category__wrapper-3 mb-60 d-sm-flex align-items-end justify-content-between">
                        ...
                        <div class="category__more mb-10">
                           <a href="https://wprealizer.com/wp/saasto/course-style-01/" class="tp-btn-5 tp-btn-8">All Categories</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                           <ul>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Python <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Web Development <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Machine Learning <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">App Development <i class="fa-regular fa-arrow-right"></i></a></li>
                           </ul>
                        </div>
                        <div class="category__btn-3">
                           <a href="https://wprealizer.com/wp/saasto/course-style-01/" class="tp-btn-9 w-100">Explore</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                           <ul>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Cyber Security <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Visual Studio Code <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">AWS Certification <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Ethical Hacking <i class="fa-regular fa-arrow-right"></i></a></li>
                           </ul>
                        </div>
                        <div class="category__btn-3">
                           <a href="https://wprealizer.com/wp/saasto/course-style-01/" class="tp-btn-9 w-100">Explore</a>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                           <ul>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Advertising <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">UX Design <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">History of Art <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Color & Form <i class="fa-regular fa-arrow-right"></i></a></li>
                           </ul>
                        </div>
                        <div class="category__btn-3">
                           <a href="https://wprealizer.com/wp/saasto/course-style-01/" class="tp-btn-9 w-100">Explore</a>
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="category__item-3 fix transition-3 white-bg mb-30">
                        ...
                        <div class="category__list">
                           <ul>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Accounting <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Financial Analysis <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">SQL <i class="fa-regular fa-arrow-right"></i></a></li>
                              <li><a href="https://wprealizer.com/wp/saasto/course-style-01/">Business statistics <i class="fa-regular fa-arrow-right"></i></a></li>
                           </ul>
                        </div>
                        <div class="category__btn-3">
                           <a href="https://wprealizer.com/wp/saasto/course-style-01/" class="tp-btn-9 w-100">Explore</a>
            ...
            <div class="container">
               ...
               <div class="row">
                     ...
                     <div class="course__item-3 white-bg transition-3 mb-30">
                        ...
                        <div class="course__content-3">
                           <h3 class="course__title-3">
                              <a href="https://wprealizer.com/wp/saasto/course-details/">Mechanical Engineering and Engineering Explained.</a>
                           </h3>
                           ...
                           <div class="course__join">
                              <a href="https://wprealizer.com/wp/saasto/course-details/" class="tp-btn-5 tp-btn-10">Join New</a>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item-3 white-bg transition-3 mb-30">
                        ...
                        <div class="course__content-3">
                           <h3 class="course__title-3">
                              <a href="https://wprealizer.com/wp/saasto/course-details/">The Challenge Of Global LearningIn Public Education.</a>
                           </h3>
                           <div class="course__meta d-flex align-items-center justify-content-between">
                              <div class="course__tag-3">
                                 <a href="#">Mechanical</a>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
                     <div class="course__item-3 white-bg transition-3 mb-30">
                        ...
                        <div class="course__content-3">
                           <h3 class="course__title-3">
                              <a href="https://wprealizer.com/wp/saasto/course-details/">Become a UI/UX Designer Everything You need To Know.</a>
                           </h3>
                           <div class="course__meta d-flex align-items-center justify-content-between">
                              <div class="course__tag-3">
                                 <a href="#">Marketing</a>
               ...
               <div class="row justify-content-center">
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="course__enroll-wrapper mt-40 p-relative d-sm-flex align-items-center justify-content-between include-bg" data-background="<?php echo get_template_directory_uri(); ?>/assets/img/course/bg/course-bg.png">
                        ...
                        <div class="course__enroll-btn pt-5">
                           <a href="https://wprealizer.com/wp/saasto/contact/" class="tp-btn-5 tp-btn-11">Get started</a>
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="container">
               <div class="certificate__inner grey-bg-9 p-relative">
                  <div class="certificate__thumb">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/img/certificate/certificate.png" alt="img">
                  </div>
                  <div class="row">
                     <div class="col-xxl-7">
                        <div class="certificate__content">                      
                           <div class="section__title-wrapper mb-10">
                              ...
                              <h2 class="section__title section__title-44">You can be your own <br> Guiding star with our help!</h2>
                           </div>
                           ...
                           <div class="certificate__links d-sm-flex align-items-center">
                              ...
                              <ul>
                                 <li><a href="https://wprealizer.com/wp/saasto/about/">Ridiculus</a></li>
                                 <li><a href="https://wprealizer.com/wp/saasto/about/">Retrun</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="price__banner theme-bg-3 mb-30 fix p-relative">
                        ...
                        <div class="price__banner-content p-relative z-index-1">
                           ...
                           <a href="https://wprealizer.com/wp/saasto/contact/" class="tp-price-btn">Choose Plan</a>
                        </div>
                        <div class="price__thumb">
                           <img src="<?php echo get_template_directory_uri(); ?>/assets/img/price/price-thumb.png" alt="img">
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div class="price__item white-bg mb-30 transition-3 fix">
                        ...
                        <div class="price__content">
                           ...
                           <div class="price__btn">
                              <a href="https://wprealizer.com/wp/saasto/contact/" class="tp-btn-9 tp-btn-12 w-100">Choose Plan</a>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="row">
                  <div class="col-xxl-5 col-xl-5 col-lg-5">
                     <div class="faq__wrapper pt-45 pr-25">
                        ...
                        <p>Join our club member community now to get free updates and also a lot of freebies are waiting for you or <a href="https://wprealizer.com/wp/saasto/contact/">Contact Us</a></p>

                        <div class="faq__btn">
                           <a href="https://wprealizer.com/wp/saasto/about/" class="tp-btn-5 tp-btn-13">Read our full FAQ</a>
                        </div>
                     </div>
                  </div>
