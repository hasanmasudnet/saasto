<?php
    ...
    $author_info = get_the_author_meta( 'saasto_write_by');
    $facebook_url = get_the_author_meta( 'saasto_facebook' );
    $twitter_url = get_the_author_meta( 'saasto_twitter' );
    $linkedin_url = get_the_author_meta( 'saasto_linkedin' );
    $instagram_url = get_the_author_meta( 'saasto_instagram' );
    $saasto_url = get_the_author_meta( 'saasto_youtube' );
    $saasto_write_by = get_the_author_meta( 'saasto_write_by' );
