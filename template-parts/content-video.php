...
$saasto_video_url = function_exists( 'get_field' ) ? get_field( 'fromate_style' ) : NULL;
...
?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item format-video mb-50' );?>>
        ...
        <div class="postbox__thumb postbox__video w-img p-relative">
          ...
          <a href="<?php print esc_url( $saasto_video_url );?>" class="play-btn pulse-btn popup-video"><i class="fas fa-play"></i></a>
          <?php endif; ?>
        </div>
        <?php endif;?>
