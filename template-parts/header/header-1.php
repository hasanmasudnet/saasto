<?php 
	...
	*/
    ...
    $saasto_mail_id = get_theme_mod( 'saasto_mail_id', __( 'info@educal.com', 'saasto' ) );
...
<header>
 <div class="header__area">
 	<?php if ( !empty( $saasto_topbar_switch ) ): ?>
          ...
          <div class="row align-items-center">
             <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                <div class="header__info">
                   <ul>
                      ...
                      <li>
                         <a href="mailto:<?php echo esc_attr($saasto_mail_id); ?>"> 
                            ...
                            </svg> <?php echo esc_html($saasto_mail_id); ?></a>
                      </li>
                    <?php endif; ?> 
                    <?php if ( !empty( $saasto_address ) ): ?>
                      <li>
                         <a href="<?php echo esc_html($saasto_address_url); ?>" target="_blank">
                            ...
                            <?php echo esc_html($saasto_address); ?></a>
                      </li>
                      <?php endif; ?> 
                   </ul>
                </div>
             ...
             <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                <div class="header__top-right d-flex justify-content-end align-items-center">
                	<?php if ( !empty( $saasto_acc_button_text ) ): ?>
                    <div class="header__login">
                      <a href="<?php echo esc_html($saasto_acc_button_link); ?>"><svg viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                         ...
                         </svg> <?php echo esc_html($saasto_acc_button_text); ?></a>
                    </div>
                	<?php endif; ?>

                    <?php if ( !empty( $saasto_button_text ) ): ?>
                    <div class="header__btn ml-20">
                    	<a href="<?php echo esc_html($saasto_button_link); ?>" class="header-btn"><?php echo esc_html($saasto_button_text); ?></a>
                    </div>
                    <?php endif; ?>
