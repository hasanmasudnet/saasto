<?php 
   ...
   // info
   $saasto_topbar_switch = get_theme_mod( 'saasto_topbar_switch', false );
   $saasto_phone_num = get_theme_mod( 'saasto_phone_num', __( '+(088) 234 567 899', 'saasto' ) );
   $saasto_mail_id = get_theme_mod( 'saasto_mail_id', __( 'info@saasto.com', 'saasto' ) );
   $saasto_address = get_theme_mod( 'saasto_address', __( 'Moon ave, New York, 2020 NY US', 'saasto' ) );
   $saasto_address_url = get_theme_mod( 'saasto_address_url', __( 'https://goo.gl/maps/qzqY2PAcQwUz1BYN9', 'saasto' ) );

   // contact button
   $saasto_button_text = get_theme_mod( 'saasto_button_text', __( 'Contact Us', 'saasto' ) );
   $saasto_button_link = get_theme_mod( 'saasto_button_link', __( '#', 'saasto' ) );

   // acc button
   $saasto_acc_button_text = get_theme_mod( 'saasto_acc_button_text', __( 'Login', 'saasto' ) );
   $saasto_acc_button_link = get_theme_mod( 'saasto_acc_button_link', __( '#', 'saasto' ) );

   // header right
   $saasto_search = get_theme_mod( 'saasto_search', false );
   $saasto_header_right = get_theme_mod( 'saasto_header_right', false );
   $saasto_menu_col = $saasto_header_right ? 'col-xxl-7 col-xl-7 col-lg-8 d-none d-lg-block' : 'col-xxl-10 col-xl-10 col-lg-9 d-none d-lg-block text-end';
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block">
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        <?php if ( !empty( $saasto_phone_num ) ): ?>   
                        <h4><a href="tel:<?php echo esc_attr($saasto_phone_num); ?>"><?php echo esc_html($saasto_phone_num); ?></a></h4>
                        <?php endif; ?> 
                        <?php if ( !empty( $saasto_mail_id ) ): ?>   
                        <p><a href="mailto:<?php echo esc_attr($saasto_mail_id); ?>"><?php echo esc_html($saasto_mail_id); ?></a></p>
                        <?php endif; ?> 
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-8 col-6">
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     <div class="header__lang d-none d-md-block">
                        <?php saasto_header_lang_defualt(); ?>
                     </div>

                     <?php if ( !empty( $saasto_acc_button_link ) ): ?>
                     <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                        ...
                        <div class="header__login-content">
                           <p><a href="<?php echo esc_html($saasto_acc_button_link); ?>"><?php echo esc_html__('Login','saasto'); ?></a></p>
                           <p><a href="<?php echo esc_html($saasto_acc_button_link); ?>"><?php echo esc_html__('Register','saasto'); ?></a></p>
                        </div>
                     </div>
                     <?php endif; ?>
            ...
            <div class="col-xxl-4 col-xl-3 col-lg-2 col-md-6 col-6">
               <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                  ...
                  <div class="header__action d-none d-xl-block">
                     <ul>
                        <li>
                           <a href="<?php echo esc_html($saasto_acc_button_link); ?>">
                  ...
                  <div class="header__search header__search-2 header__search-3 d-none d-xl-block">
                     <form action="<?php print esc_url( home_url( '/' ) );?>">
                        <div class="header__search-input">
                           <input type="text" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php print esc_attr__( 'Search...', 'saasto' );?>">
